...
Assert (($manifest.activities | Where-Object access_tier -eq "premium").Count -eq 113) "Expected 113 Premium activities."
...
Assert ($guarded.Count -eq 142) "Expected guard on 142 catalogue/activity pages; found $($guarded.Count)."
