...
const plans = new Map([
  [39900, { tier: "Starter", productName: "NexCompany — Starter" }],
  [59900, { tier: "Standard", productName: "NexCompany — Standard" }],
  [109900, { tier: "Business", productName: "NexCompany — Business" }],
]);
