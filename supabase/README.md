...
Authenticated accounts receive access through 20 August 2026 via `profiles.content_access_until`. After the promotion, extend this timestamp for paid subscribers; administrators retain access.
